    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="position: absolute; width: 100%; height: 100%; min-height: 800px">
        <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="../management/mktdashboard" class="nav-link text-white home-link <c:if test="${pageContext.request.requestURI.endsWith('MKTdashboard.jsp')}">active bg-secondary</c:if>" aria-current="page">
                            <!-- Dashboard Icon -->
