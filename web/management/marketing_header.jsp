    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="position: absolute; width: 100%; height: 100%; min-height: 800px">
        <hr>
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="mktdashboard" class="nav-link text-white home-link <c:if test="${pageContext.request.requestURI.endsWith('mkt_dashboard.jsp')}">active bg-secondary</c:if>" aria-current="page">
                            <!-- Dashboard Icon -->
                    ...
                    <li>
                        <a href="slider" class="nav-link text-white account-link <c:if test="${pageContext.request.requestURI.endsWith('slider.jsp')}">active bg-secondary</c:if>">
                            <!-- Slider Icon -->
                    ...
                    <li>
                        <a href="CustomerServlet" class="nav-link text-white station-link <c:if test="${pageContext.request.requestURI.endsWith('customerlist.jsp')}">active bg-secondary</c:if>">
                            <!-- Customer Icon -->
                    ...
                    <li>
                        <a href="feedback" class="nav-link text-white contract-link <c:if test="${pageContext.request.requestURI.endsWith('productfeedbacklist.jsp')}">active bg-secondary</c:if>">
